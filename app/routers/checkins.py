...
async def set_checkin(habit_id: int, checkins_service: CheckinsService = Depends(get_checkins_service)):
	try:
		await checkins_service.set_checkin(habit_id=habit_id)
...
async def delete_checkin(
	...
	try:
		await checkins_service.delete_checkin(habit_id=habit_id, date=date)
